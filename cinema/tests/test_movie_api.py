...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_title(self):
        movie1 = sample_movie(title="Movie AAA")
        movie2 = sample_movie(title="Movie BBB")

        res = self.client.get(MOVIE_URL, {"title": "AAA"})
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie1 = sample_movie(title="Tom Movie")
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_actors(self):
        ...
        actor2 = sample_actor(first_name="Carrie-Anne", last_name="Moss")
